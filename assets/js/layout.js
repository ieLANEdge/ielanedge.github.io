...
<div id="loader" class="loader">
  <div class="loader-logo">ieLAN Edge</div>
  <div class="loader-tag">Amal to Impact</div>
...
<nav>
  ...
  <div class="nav-right">
    <button class="theme-toggle" id="themeToggle" title="Toggle theme" aria-label="Toggle dark mode">&#9789;</button>
    ...
    <div class="footer-grid">
      <div class="footer-brand">
        ...
        <div class="footer-socials">
          <a href="https://www.linkedin.com/company/ieLANedge/" class="social-btn" title="LinkedIn" aria-label="LinkedIn">in</a>
          <a href="https://x.com/ielanedge" class="social-btn" title="X (Twitter)" aria-label="X (Twitter)">X</a>
          <a href="https://www.facebook.com/ielanedge" class="social-btn" title="Facebook" aria-label="Facebook">f</a>
          <a href="https://www.youtube.com/@ieLANEdge" class="social-btn" title="YouTube" aria-label="YouTube">YT</a>
        </div>
      </div>
      <div>
      ...
      <div>
        ...
        <ul class="footer-col-links">
          ...
          <li><a href="${rootPath}pages/about.html#presence">India · Noida</a></li>
          <li><a href="${rootPath}pages/about.html#presence">Global Remote</a></li>
        </ul>
      </div>
    </div>
...
<div class="install-banner" id="installBanner">
  <div class="install-banner-text"><strong>Install ieLAN Edge</strong> — access our site anytime, even offline.</div>
...
(function() {
  const t = localStorage.getItem('ielan-theme') || 'light';
